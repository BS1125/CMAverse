...
We illustrate the general workflow of the `CMAverse` package by a quick example. Firstly, let's simulate some data and plot the DAG of the scientific setting. The simulated data contains a binary exposure, a binary mediator, a continuous mediator, a continuous outcome and two pre-exposure confounders.
