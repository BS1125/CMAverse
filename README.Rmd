...
Then, assume that the exposure was measured with error. Sensitivity analysis for measurement error using MCSIMEX with two assumed misclassification matrices:
