...
Estimation: Direct Imputation & $\surd$& $\surd$& $\surd$& $\times$& $\surd$& $\surd$ \\ \hline
Inference: Delta Method & $\surd$& $\times$& $\surd$& $\times$& $\times$& $\times$ \\ \hline
...
Estimation: Direct Imputation & $\surd$& $\surd$& $\surd$& $\times$& $\surd$& $\surd$ \\ \hline
Inference: Delta Method & $\times$& $\times$& $\times$& $\times$& $\times$& $\times$ \\ \hline
Inference: Bootstrapping & $\surd$& $\surd$& $\surd$& $\surd$& $\surd$& $\surd$ \\ \hline
\end{tabular}
\end{center}
...
$rr^{CDE}=E[Y_{am}|C]/E[Y_{a^*m}|C]$

$rr^{PNDE}=E[Y_{aM_a^*}|C]/E[Y_{a^*M_a^*}|C]$

$rr^{TNDE}=E[Y_{aM_a}|C]/E[Y_{a^*M_a}|C]$

$rr^{PNIE}=E[Y_{a^*M_a}|C]/E[Y_{a^*M_a^*}|C]$

$rr^{TNIE}=E[Y_{aM_a}|C]/E[Y_{aM_a^*}|C]$
...
$err^{CDE}=(E[Y_{am}-Y_{a^*m}|C])/E[Y_{a^*M_a^*}|C]$
...
6. Use bootstrapping to get the standard error.
...
4. For single-mediator cases, get the standard error using the delta method or bootstrapping; for multiple-mediator cases, get the standard error using bootstrapping.
