...
In this setting, we have a count mediator, so we can't use the marginal structural model. We can the rest five statistical modeling approaches. The results are shown below.
