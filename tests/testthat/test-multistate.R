...
test_that("The multistate method correctly estimates RD and SD for a continuous exposure", {
  # generate data
  # set up coefficients 
  # M (trans 1)
  a1 = -1.9 
...
test_that("The multistate method correctly estimates RD and SD for a binary exposure", {
  # generate data
  # set up coefficients 
  # M (trans 1)
  a1 = -1.9 
